...
<body>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/common/login/bootstrap.bundle.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/common/login/jquery-3.3.1.slim.min.js"></script>
</body>
</html>